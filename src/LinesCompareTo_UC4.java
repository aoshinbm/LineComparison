...
public class LinesCompareTo_UC4 {
    ...
    static double line1Calculation(int x1, int x2, int y1, int y2) {
        ...
        System.out.println("Length of Line1 :"+len_line1);
        return len_line1;
    }
    static double line2Calculation(int a1, int a2, int b1, int b2) {
        int line2;
        line2= (int) (Math.pow((a2-a1),2)+Math.pow((b2-b1),2));
        System.out.println("Line2: "+line2);
        len_line2 = Math.sqrt(line2);
        System.out.println("Length of Line2 :"+len_line2);
        return len_line2;
    }
